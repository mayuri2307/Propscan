        ...
        <div className='header'>
            <div style={{display:"flex", alignItems:"flex-end", justifyContent: "space-between"}}>
                ...
                <div className='header-items'>
                    <span className='px-5'>Sell <img src="images/img_checkmark.svg" style={{paddingBottom:"2px"}} /></span>
                    <span className='px-5'>Buy <img src="images/img_checkmark.svg" style={{paddingBottom:"2px"}} /></span>
